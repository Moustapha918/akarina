...
export default function InvestPaymentScreen() {
  ...
  async function startPayment() {
    ...
    try {
      ...
      if (result.success) {
        await updateInvestmentStatus(investmentId, 'SUCCESS', {
          bankilyRef: result.bankilyRef,
        });
        setPaymentState('success');
        // Navigate automatically after brief success display
        setTimeout(() => {
        ...
        setErrorMessage(result.errorMessage ?? 'Transaction refusée.');
      ...
      <View style={styles.body}>
        ...
        {paymentState === 'processing' && (
          <View style={styles.stateBlock}>
            ...
            <Text style={styles.stateSubtitle}>
              Un code OTP a été envoyé sur le numéro :{'\n'}
              <Text style={styles.phoneHighlight}>{user?.phone ?? '—'}</Text>
            </Text>
            <Text style={styles.stateSubtitle}>Validez le paiement sur votre téléphone.</Text>

            <View style={styles.countdownRow}>
              <ActivityIndicator color={COLORS.primary} size="small" />
              <Text style={styles.countdownText}>
                Traitement en cours — {countdown}s
              </Text>
            </View>

            <Text style={styles.simulationNote}>
              ⓘ Mode simulation : le paiement sera automatiquement validé
            </Text>
          </View>
        )}
        ...
        {paymentState === 'success' && (
          <View style={styles.stateBlock}>
            ...
            <Text style={styles.stateTitle}>Paiement accepté !</Text>
            <Text style={styles.stateSubtitle}>Redirection vers la confirmation...</Text>
          </View>
        )}
